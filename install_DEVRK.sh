...
if [ $var1 = ubuntu_A5 ];
then
echo '\033[1;31mInstalling dependencies of Ubuntu 14.04 and OpenJDK 7\e[0m'
...
chmod a+x ~/bin/repo
echo '\033[1;31mInstalling REPO in your .bashrc\e[0m'
echo "export PATH=~/bin:$PATH" >> ~/.bashrc
echo "umask 022" >> ~/.bashrc
echo '\033[1;31mDownloading prebuilts tools (arm-eabi 4.6) in ~/DEV\e[0m'
mkdir ~/DEV
chmod 777 -R ~/DEV
cd ~/DEV
...
if [ $var1 = opensuse_A5 ];
then
echo '\033[1;31mInstalling dependencies of opensuse 13.x and OpenJDK 7\e[0m'
...
if [ $var1 = arch_A5 ];
then
echo '\033[1;31mInstalling dependencies of ArchLinux and OpenJDK 7, you needs multilib repository in /etc/pacman.conf and yaourt\e[0m'
...
echo "export PATH=~/bin:$PATH" >> ~/.bashrc
echo "umask 022" >> ~/.bashrc
echo '\033[1;31mDownloading prebuilts tools (arm-eabi 4.6) in ~/DEV\[0m'
mkdir ~/DEV
chmod 777 ~/DEV
cd DEV
git clone https://github.com/EPDCenterSpain/rk-prebuilts.git
...
if [ $var1 = fedora_A5 ];
then
echo '\033[1;31mInstalling dependencies of Fedora and OpenJDK7\e[0m'
...
if [ $var1 = fedora_A4 ];
then
echo '\033[1;31mInstalling dependencies of Fedora and OpenJDK6\e[0m'
...
if [ $var1 = rockchip ];
then
echo '\033[1;31mInstalling rockchip flash tool in ~/DEV || Thanks to crewrktablets // http://crewrktablets.de\e[0m'
cd ~/DEV
...
cd
sleep 20
echo '\033[1;31mFixing ADB Rockchip\e[0m'
